...
const UpdateItem = ({ navigation }) => {
  ...
  let searchItem = () => {
    ...
    db.transaction((tx) => {
      tx.executeSql(
        'SELECT * FROM table_item where item_id = ?',
        [inputItemId],
        (tx, results) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ flex: 1, backgroundColor: '#211225' }}>
        <View style={{ flex: 1}}>
          <ScrollView keyboardShouldPersistTaps="handled">
            <KeyboardAvoidingView
              ...
              <Mytextinput
                ...
                onChangeText={
                  (inputItemId) => setinputItemId(inputItemId)
                }
              />
              <Mybutton
                title="Buscar Item"
                customClick={searchItem}
              />
              <Mytextinput
              ...
              <Mytextinput
                ...
                onChangeText={
                  (itemQuantidade) => setitemQuantidade(itemQuantidade)
                }
                maxLength={10}
                style={{ padding: 10 , color: '#fff' }}
              ...
              <Mytextinput
                ...
                onChangeText={
                  (itemPreco) => setitemPreco(itemPreco)
                }
                maxLength={225}
                multiline={true}
